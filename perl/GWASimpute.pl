...
'impute22 -pgs_miss IMPUTE_CMDLINE -h HAP_FILE -l LEGEND_FILE -m MAP_FILE -g GENOTYPE_FILE -o OUTPUT_DIR/OUTPUT_FILE -sample OUTPUT_DIR/sex.sample -Ne NUMBER_NE -buffer NUMBER_BUFFER -k NUMBER_K -iter NUMBER_ITERATIONS -burnin NUMBER_BURNIN -fix_strand_g -int NUMBER_START NUMBER_STOP';
