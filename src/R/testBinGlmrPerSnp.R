...
testGlmrPerSnp = function(data, formula1, formula0, snp, ...) {
	#<!> fid hardcoded due to IBC access dificulties
	r = regressionCompareModels(formula1, formula0, data, type = "glmr", clusterCol = 'fid', family = binomial());
